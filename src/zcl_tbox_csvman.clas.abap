CLASS zcl_tbox_csvman DEFINITION
  ...
  PUBLIC SECTION.
    ...
    RETURNING
      VALUE(r) TYPE REF TO zcl_tbox_csv_writer .
    CLASS-METHODS get_reader
    RETURNING
      VALUE(r) TYPE REF TO zcl_tbox_csv_reader .
    CLASS-METHODS class_constructor .
    CLASS-METHODS get_normalized_type
    IMPORTING
      !i_typekind TYPE clike
    RETURNING
      VALUE(r) TYPE abap_typekind .
  PROTECTED SECTION.
  PRIVATE SECTION.
    ...
    CLASS-DATA:
    g_typekinds_normalization TYPE TABLE OF ts_typekind_normalization WITH KEY typekind .
...
CLASS zcl_tbox_csvman IMPLEMENTATION.
  ...
  METHOD _load_typekinds.
    ...
    g_typekinds_normalization = VALUE #(
